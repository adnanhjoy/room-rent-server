...
export class TestService {
    ...
    async updateTest(id: string, updateData: Partial<CreateTestDto>): Promise<Test> {
        const updated = await this.testModel.findByIdAndUpdate(id, updateData, { new: true }).exec();
